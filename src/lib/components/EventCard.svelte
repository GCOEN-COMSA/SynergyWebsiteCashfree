...
<div class="card mx-auto max-w-xs md:max-w-md lg:max-w-lg aspect-video bg-base-200 shadow-xl image-full max-h-60 my-8">
    <!-- <figure><img src="{image ? image : 'https://placeimg.com/400/225/tech'}" alt="Shoes" /></figure> -->
    <figure class="self-stretch"><img src="{event_card}" alt="Shoes" class="self-stretch " /></figure>
    ...
    <div class="card-body">
      ...
      <div class="card-actions justify-end">
        ...
        {#if !event.hide}
        <button on:click|stopPropagation={onLearnMore} class="btn">Explore</button>
        {/if}
      </div>
    </div>
  </div>
